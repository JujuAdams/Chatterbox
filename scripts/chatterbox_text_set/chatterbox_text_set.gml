...
if (_is_button)
{
    ...
    repeat (_count)
    {
        ...
        _new_array[ CHATTERBOX_PROPERTY.XSCALE   ] = CHATTERBOX_DEFAULT_BUTTON_XSCALE;
        _new_array[ CHATTERBOX_PROPERTY.YSCALE   ] = CHATTERBOX_DEFAULT_BUTTON_YSCALE;
        _new_array[ CHATTERBOX_PROPERTY.XY_SCALE ] = undefined;
        _new_array[ CHATTERBOX_PROPERTY.ANGLE    ] = CHATTERBOX_DEFAULT_BUTTON_ANGLE;
        _new_array[ CHATTERBOX_PROPERTY.COLOUR   ] = CHATTERBOX_DEFAULT_BUTTON_COLOUR;
        _new_array[ CHATTERBOX_PROPERTY.ALPHA    ] = CHATTERBOX_DEFAULT_BUTTON_ALPHA;
        _new_array[ CHATTERBOX_PROPERTY.PMA      ] = CHATTERBOX_DEFAULT_BUTTON_PMA;
