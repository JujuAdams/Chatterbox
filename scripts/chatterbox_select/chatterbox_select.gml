            ...
            switch(_instruction_type)
            {
                ...
                case __CHATTERBOX_VM_ELSEIF:
                    ...
                    if (_instruction_type == __CHATTERBOX_VM_IF)
                    {
                        if (!_if_state)
                        {
                            if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     _if_state == " + string(_if_state));
                            _continue = true;
                    ...
                    if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":   Evaluator returned \"" + string(_result) + "\" (" + typeof(_result) + ")");
                    ...
                    if (_if_state)
                    {
                        ...
                        if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":   Set _permit_greater_indent = " + string(_permit_greater_indent));
                    }
                break;
                
                case __CHATTERBOX_VM_ELSE:
                    _if_state = !_if_state;
                    if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     Invert _if_state = " + string(_if_state));
        ...
        if (!_break && !_continue)
        {
            ...
            switch(_instruction_type)
            {
                case __CHATTERBOX_VM_WAIT:
                    ...
                    if (_scan_from_text)
                    {
                        if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     _scan_from_text == " + string(_scan_from_text));
                        _break = true;
                ...
                case __CHATTERBOX_VM_TEXT:
                    ...
                    if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     Set _indent_for_options = " + string(_indent_bottom_limit));
                ...
                case __CHATTERBOX_VM_OPTION:
                    ...
                    if (!_scan_from_text)
                    {
                        if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     _at_scan_end_instruction == " + string(_at_scan_end_instruction));
                    ...
                    if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     New option \"" + string(_new_option_text) + "\"");
                ...
                case __CHATTERBOX_VM_SHORTCUT:
                    ...
                    if (!_scan_from_text)
                    {
                        if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     instruction=" + string(_instruction) + " vs. end=" + string(_end_instruction));
                        if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     indent=" + string(_indent) + " >= start=" + string(_start_indent));
                ...
                case __CHATTERBOX_VM_SET:
                    ...
                    if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":     now executing");
                ...
                case __CHATTERBOX_VM_STOP:
                    ...
                    if (CHATTERBOX_DEBUG_SELECT) __chatterbox_trace("" + string(_instruction) + ":       Stop");
                    exit;
