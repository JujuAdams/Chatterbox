...
_chatterbox[| __CHATTERBOX.TEXT_MIN_LINE_HEIGHT ] = argument1;
_chatterbox[| __CHATTERBOX.TEXT_MAX_LINE_WIDTH  ] = argument2;
_chatterbox[| __CHATTERBOX.TEXT_STARTING_COLOUR ] = argument3;
_chatterbox[| __CHATTERBOX.TEXT_STARTING_FONT   ] = argument4;
_chatterbox[| __CHATTERBOX.TEXT_STARTING_HALIGN ] = argument5;
_chatterbox[| __CHATTERBOX.TEXT_DATA_FIELDS     ] = argument6;
return true;