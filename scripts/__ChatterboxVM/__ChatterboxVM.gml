...
function __ChatterboxVMInner(_instruction)
{
    ...
    if (is_string(_instructionType))
    {
        ...
        else
        {
            ...
            if ((not entered_option) && (not moveAhead)
            &&  singleton_text && (array_length(content) > 0)
            &&  ((_instructionType != "option") || CHATTERBOX_SINGLETON_WAIT_BEFORE_OPTION)
            &&  (_instructionType != "wait")
                        ...
                        switch(_instructionType)
                        {
                            ...
                            case "hop":
                                ...
                                if (_split.filename == undefined)
                                {
                                    ...
                                    __ChangeNode(_next_node, true, _instructionType);
                            ...
                            case "stop":
                            case "hopback":
                                if ((_instructionType == "stop") || __HopEmpty())
                                {
                            ...
                            default:
                                if (__CHATTERBOX_DEBUG_VM) __ChatterboxTrace("\"", _instructionType, "\" instruction ignored");
                            break;
                        }
                    }
                }
