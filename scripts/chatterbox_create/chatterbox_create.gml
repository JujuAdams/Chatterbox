...
_chatterbox[| __CHATTERBOX.TEXT_FADE_IN_SPEED         ] = undefined;
_chatterbox[| __CHATTERBOX.TEXT_FADE_IN_SMOOTHNESS    ] = undefined;
_chatterbox[| __CHATTERBOX.TEXT_FADE_IN_METHOD        ] = undefined;
_chatterbox[| __CHATTERBOX.TEXT_FADE_OUT_SPEED        ] = undefined;
_chatterbox[| __CHATTERBOX.TEXT_FADE_OUT_SMOOTHNESS   ] = undefined;
_chatterbox[| __CHATTERBOX.TEXT_FADE_OUT_METHOD       ] = undefined;
...
_chatterbox[| __CHATTERBOX.OPTION_FADE_IN_SPEED       ] = undefined;
_chatterbox[| __CHATTERBOX.OPTION_FADE_IN_SMOOTHNESS  ] = undefined;
_chatterbox[| __CHATTERBOX.OPTION_FADE_IN_METHOD      ] = undefined;
_chatterbox[| __CHATTERBOX.OPTION_FADE_OUT_SPEED      ] = undefined;
_chatterbox[| __CHATTERBOX.OPTION_FADE_OUT_SMOOTHNESS ] = undefined;
_chatterbox[| __CHATTERBOX.OPTION_FADE_OUT_METHOD     ] = undefined;
