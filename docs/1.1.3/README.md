...
-   **Tools**<br>
    Chatterbox is designed to be easy to implement and easy to make games with. [Yarn script](concept-yarn-script) can be written by hand or, more commonly, an editor is used to write your stories. There's a [web editor](https://yarnspinnertool.github.io/YarnEditor/) as well as [Windows, MacOS, & Ubuntu](https://github.com/YarnSpinnerTool/YarnEditor/releases/) binaries. Chatterbox loads in Yarn files straight from your [Included Files](https://manual.yoyogames.com/Settings/Included_Files.htm) with a [single command](reference-configuration#chatterboxloadfromfilefilename-aliasname) without any other setup.
